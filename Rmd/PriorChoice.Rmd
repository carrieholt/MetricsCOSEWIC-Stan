...
Sensitivity of declines estimates were further evaluate to three different SDs for normally distributed priors on slope and Y-intercept, representing generically weakly informative priors (sigma = 1), weakly informative priors (sigma =10), and a moderate value between those (sigma = 2.5) as applied in rstanarm (described by Gelman, <https://github.com/stan-dev/stan/wiki/Prior-Choice-Recommendations#scaling>).
